...
export const calendarEvents = pgTable('calendar_events', {
    ...
    return {
        ...
        userDateRangeIdx: index('idx_calendar_user_date_range').on(table.userId, table.start, table.end),
    };
});
...
export const followUps = pgTable('follow_ups', {
    ...
    return {
        userFollowUpAtIdx: index('idx_followups_user_follow_up_at').on(table.userId, table.followUpAt),
...
export const contactPreferences = pgTable('contact_preferences', {
    ...
    return {
        userContactIdx: index('idx_contact_prefs_user_contact').on(table.userId, table.contactEmail),
    };
});
