...
export interface IConversationContext {
  ...
  // Memory - people, dates, projects referenced
...
export interface IDateRef {
  timestamp: Timestamp;
  description: string;
  relative?: string; // "tomorrow", "next week"
}
...
export interface IActionResult {
  ...
  error?: string;
  undoable: boolean;
  undoWindow?: number; // milliseconds
}
...
export interface IOrganizationChart {
  reporting: Record<string, UserId>; // userId -> managerId
  teams: Record<string, UserId[]>; // teamName -> userIds
}
