...
export type IntelligenceType = 'email_pattern' | 'temporal_pattern' | 'sequence_pattern' | 'automation_suggestion' | 'behavioral_pattern' | 'optimization_opportunity' | 'other';
...
export type ActionSuggestionType = 'email_response' | 'schedule_meeting' | 'delegate_task' | 'decline_meeting' | 'archive_email' | 'send_reminder' | 'update_task' | 'reschedule_meeting' | 'other';
...
export type DecisionType = 'approval' | 'choice' | 'prioritization' | 'scheduling' | 'budget' | 'strategic' | 'operational' | 'other';
