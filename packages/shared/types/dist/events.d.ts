...
export type UserRegisteredEvent = BaseEvent<UserEventType.USER_REGISTERED, {
    userId: UserId;
    email: string;
    name: string;
    registeredAt: string;
}>;
export type UserAuthenticatedEvent = BaseEvent<UserEventType.USER_AUTHENTICATED, {
    userId: UserId;
    email: string;
    ip: string;
    userAgent: string;
...
export type MessageReceivedEvent = BaseEvent<MessageEventType.MESSAGE_RECEIVED, {
    messageId: MessageId;
...
export type EmailTriagedEvent = BaseEvent<EmailEventType.EMAIL_TRIAGED, {
    emailId: EmailId;
    userId: UserId;
