 ...
 */
import type { UserId, UserPreferencesId, CommandId, EmailId, ThreadId, CalendarEventId, DraftId, FollowUpId, ContactPreferencesId, FeedbackId, AuditLogId } from './branded.types.js';
export type EmailProvider = 'gmail' | 'outlook';
export type CalendarProvider = 'google' | 'outlook';
export type CommandStatus = 'pending' | 'processing' | 'pending_approval' | 'completed' | 'failed' | 'cancelled';
export type CommandIntent = 'schedule_meeting' | 'draft_email' | 'send_email' | 'search_email' | 'get_meeting_context' | 'reschedule_meeting' | 'cancel_meeting' | 'set_follow_up' | 'get_daily_brief' | 'get_availability' | 'update_preferences';
...
export type AuditAction = 'user.created' | 'user.updated' | 'user.deleted' | 'email.sent' | 'email.drafted' | 'email.deleted' | 'calendar.event_created' | 'calendar.event_updated' | 'calendar.event_deleted' | 'command.processed' | 'command.approved' | 'command.rejected' | 'draft.created' | 'draft.approved' | 'draft.rejected' | 'draft.sent';
...
export interface UserPreferencesRow {
    ...
    autoAcceptMeetingsFrom: string;
    autoRespondSimple: boolean;
    autoRespondConfidence: string;
...
export type CommandInsert = Omit<CommandRow, 'id' | 'timestamp' | 'processingStartedAt' | 'completedAt'> & {
    id?: CommandId;
    timestamp?: Date;
    processingStartedAt?: Date;
    completedAt?: Date;
...
export type ContactPreferencesInsert = Omit<ContactPreferencesRow, 'id' | 'createdAt' | 'updatedAt'> & {
    id?: ContactPreferencesId;
    createdAt?: Date;
    updatedAt?: Date;
};
