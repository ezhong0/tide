 ...
 * Meeting type
 */
export type MeetingType = 'one-on-one' | 'team' | 'client' | 'internal' | 'external' | 'focus' | 'break';
/**
...
export interface OptimizationPlan {
    ...
    estimatedTimeRecovered: number;
    estimatedFocusTimeCreated: number;
}
/**
 * Optimization opportunity
 */
export interface Opportunity {
    type: 'consolidate_meetings' | 'skip_meeting' | 'reschedule_meeting' | 'create_focus_block' | 'reduce_meeting_time';
