...
export class SmartScheduler {
   ...
   */
  private intersectSlots(slots1: TimeSlot[], slots2: TimeSlot[]): TimeSlot[] {
   ...
   */
  private scoreDayOfWeek(slot: TimeSlot, preferredDays?: number[]): number {
   ...
   */
  private aggregateScore(factors: SlotScoreFactors): number {
    const weights = {
      timeOfDay: 0.25,
      dayOfWeek: 0.15,
      proximity: 0.15,
