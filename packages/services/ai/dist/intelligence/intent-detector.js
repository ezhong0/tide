...
export class IntentDetector {
     ...
     */
    async detect(request, modelClient) {
     ...
     */
    async detectWithModel(request, modelClient) {
...
User request: ${request.content}`;
     ...
     */
    extractDateTimeEntities(content) {
        const entities = [];
