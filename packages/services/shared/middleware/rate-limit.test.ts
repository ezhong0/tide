...
describe('rateLimit', () => {
  ...
  it('should decrement remaining count correctly', () => {
    ...
    const remainingHeader = setHeaderCalls.find((call: any) =>
      call[0] === 'X-RateLimit-Remaining'
    );
  ...
  it('should handle errors gracefully', () => {
    ...
    expect(() => limiter(mockReq as Request, mockRes as Response, mockNext)).not.toThrow();
    expect(mockNext).toHaveBeenCalled();
  });
});
