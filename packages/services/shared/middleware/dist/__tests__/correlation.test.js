...
import { correlationId, correlationLogger, getCorrelationHeaders, createCorrelationHeaders, } from '../correlation';
describe('Correlation Middleware', () => {
    ...
    describe('correlationLogger middleware', () => {
        it('should create child logger with correlation ID', () => {
            ...
            correlationLogger(mockReq, mockRes, mockNext);
    ...
    describe('getCorrelationHeaders', () => {
        it('should return headers with correlation ID from request', () => {
            ...
            const headers = getCorrelationHeaders(mockReq);
