...
import { errorHandler, APIError, BadRequestError, UnauthorizedError, ForbiddenError, NotFoundError, InternalServerError, notFoundHandler, asyncHandler, } from './error-handler.js';
...
describe('notFoundHandler', () => {
    it('should return 404 response', () => {
        const mockReq = { method: 'GET', path: '/unknown' };
        const mockRes = {
            status: vi.fn().mockReturnThis(),
            json: vi.fn(),
        };
