 ...
 */
export declare const moderateRateLimit: (req: Request, res: Response, next: NextFunction) => Response<any, Record<string, any>> | undefined;
/**
 * Lenient rate limiter for read-only endpoints
 * 300 requests per minute
 */
export declare const lenientRateLimit: (req: Request, res: Response, next: NextFunction) => Response<any, Record<string, any>> | undefined;
/**
