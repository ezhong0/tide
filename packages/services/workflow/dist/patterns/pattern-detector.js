...
class PatternDetector {
     ...
     */
    async detectPatterns(userId, days = 30) {
     ...
     */
    async detectTemporalPatterns(behaviors, userId) {
        const patterns = [];
     ...
     */
    async detectSequentialPatterns(behaviors, userId) {
        const patterns = [];
     ...
     */
    getSequenceSignature(actions) {
        return actions.join('->');
    }
    /**
     * Describe sequence in natural language
     */
    describeSequence(actions) {
        if (actions.length === 0)
...
class BehaviorAnalyzer {
     ...
     */
    analyzeTimeDistribution(behaviors) {
     ...
     */
    calculateActionFrequency(behaviors) {
