...
export interface ILearningService {
  ...
  predictPreferences(
    userId: UserId,
    category: string
  ): Promise<Result<PreferencePrediction[]>>;
  ...
  getLearnedPreferences(
    userId: UserId
  ): Promise<Result<LearnedPreference[]>>;
  ...
  applyPreference(
    preferenceId: UUID
  ): Promise<Result<PreferenceApplication>>;
  ...
  ): Promise<Result<EvaluationMetrics>>;
  ...
  getPersonalizationProfile(
    userId: UserId
  ): Promise<Result<PersonalizationProfile>>;
