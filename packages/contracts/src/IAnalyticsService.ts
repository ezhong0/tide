...
export interface IAnalyticsService {
  ...
  getProductivityAnalytics(
    userId: UserId,
    period: TimeRange
  ): Promise<Result<ProductivityAnalytics>>;
  ...
  getCommunicationAnalytics(
    userId: UserId,
    period: TimeRange
  ): Promise<Result<CommunicationAnalytics>>;
  ...
  getSystemAnalytics(
    period: TimeRange
  ): Promise<Result<SystemAnalytics>>;
  ...
  analyzeCorrelations(
    userId: UserId,
    metrics: string[]
  ): Promise<Result<CorrelationMatrix>>;
  ...
  compare(
    userId: UserId,
    compareWith: ComparisonTarget
  ): Promise<Result<ComparativeAnalytics>>;
  ...
  subscribe(
    userId: UserId,
    metrics: string[],
    handler: AnalyticsUpdateHandler
  ): Result<AnalyticsSubscription>;
}
