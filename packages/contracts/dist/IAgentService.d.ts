...
import { Agent, AgentResponse, UserRequest, UserFeedback, ReasoningStep, ExecutionPlan, Task, AgentCollaboration, AgentPerformance, Pattern, Experience } from '@tide/types';
export interface IAgentService {
     ...
     */
    coordinateAgents(objective: string, agents: AgentId[]): Promise<Result<AgentCollaboration>>;
    /**
