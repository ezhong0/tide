...
import { CalendarEvent, AvailabilityParams, MeetingConstraints, MeetingOption, CalendarHealth, CalendarSyncStatus, CalendarPreferences, WorkingHours, Participant, ResponseStatus, Reminder, ConferenceData, RecurrenceRule } from '@tide/types';
export interface ICalendarService {
     ...
     */
    findMeetingTimes(participants: Email[], constraints: MeetingConstraints): Promise<Result<MeetingOption[]>>;
    /**
     ...
     * @performance <200ms
     */
    updateEvent(eventId: EventId, updates: Partial<CalendarEvent>): Promise<Result<CalendarEvent>>;
    /**
     ...
     * @performance <100ms
     */
    cancelEvent(eventId: EventId, reason?: string, notifyAttendees?: boolean): Promise<Result<void>>;
    /**
     ...
     */
    getEvents(userId: UserId, startTime: number, endTime: number): Promise<Result<CalendarEvent[]>>;
    /**
     ...
     * @performance <200ms
     */
    addParticipant(eventId: EventId, participant: Participant, sendInvite?: boolean): Promise<Result<void>>;
    /**
     ...
     * @performance <200ms
     */
    removeParticipant(eventId: EventId, participantEmail: Email, reason?: string): Promise<Result<void>>;
    /**
     ...
     * @performance <100ms
     */
    updateParticipantResponse(eventId: EventId, participantEmail: Email, response: ResponseStatus, comment?: string): Promise<Result<void>>;
    /**
     ...
     * @performance <200ms
     */
    setConferenceData(eventId: EventId, conferenceData: ConferenceData): Promise<Result<void>>;
    /**
     ...
     * @performance <100ms
     */
    setReminders(eventId: EventId, reminders: Reminder[]): Promise<Result<void>>;
    /**
     ...
     */
    setRecurrence(eventId: EventId, recurrence: RecurrenceRule): Promise<Result<EventId[]>>;
    /**
     ...
     * @performance <200ms
     */
    modifyRecurringInstance(parentEventId: EventId, instanceDate: number, modifications: Partial<CalendarEvent>): Promise<Result<EventId>>;
    /**
     ...
     * @performance <200ms
     */
    blockFocusTime(userId: UserId, startTime: number, endTime: number, description?: string): Promise<Result<EventId>>;
    /**
     * Set out of office
     ...
     * @performance <200ms
     */
    setOutOfOffice(userId: UserId, startDate: number, endDate: number, message?: string): Promise<Result<EventId>>;
    /**
     ...
     */
    analyzeCalendarHealth(userId: UserId, startDate: number, endDate: number): Promise<Result<CalendarHealth>>;
    /**
     ...
     * @performance <100ms
     */
    updatePreferences(userId: UserId, preferences: Partial<CalendarPreferences>): Promise<Result<void>>;
    /**
     ...
     * @performance <100ms
     */
    updateWorkingHours(userId: UserId, workingHours: Partial<WorkingHours>): Promise<Result<void>>;
    /**
     ...
     * @performance <100ms
     */
    detectConflicts(userId: UserId, proposedEvent: Partial<CalendarEvent>): Promise<Result<CalendarEvent[]>>;
    /**
     ...
     * @performance <500ms
     */
    suggestOptimalTime(participants: Email[], constraints: MeetingConstraints): Promise<Result<OptimalTimeResult>>;
    /**
