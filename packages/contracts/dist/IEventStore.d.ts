...
export interface IEventStore {
     ...
     */
    getEvents(aggregateId: UUID, fromVersion?: number, toVersion?: number): Promise<Result<DomainEvent[]>>;
    /**
     ...
     * @performance <100ms for 100 events
     */
    readStream(streamName: string, fromPosition?: number, count?: number): Promise<Result<EventWithPosition[]>>;
    /**
     ...
     */
    readAll(fromPosition?: number, count?: number): Promise<Result<EventWithPosition[]>>;
    /**
     ...
     */
    getEventsByType(eventType: string, fromTimestamp?: Timestamp, toTimestamp?: Timestamp): Promise<Result<DomainEvent[]>>;
    /**
     * Get events by user
     ...
     * @performance <100ms with index
     */
    getEventsByUser(userId: UserId, fromTimestamp?: Timestamp, toTimestamp?: Timestamp): Promise<Result<DomainEvent[]>>;
    /**
     ...
     */
    subscribe(streamName: string, handler: EventHandler): Promise<Result<Subscription>>;
    /**
     ...
     * @performance <100ms
     */
    createSnapshot(aggregateId: UUID, version: number, state: unknown): Promise<Result<void>>;
    /**
     ...
     */
    replay<T>(aggregateId: UUID, handler: ReplayHandler<T>, fromVersion?: number): Promise<Result<T>>;
    /**
     ...
     * @performance <200ms
     */
    getStatistics(fromTimestamp?: Timestamp, toTimestamp?: Timestamp): Promise<Result<EventStatistics>>;
    /**
     * Begin a transaction
...
//# sourceMappingURL=IEventStore.d.ts.map