 ...
 */
import { Result, IUnderstanding, IConversationContext, IIntent, IEntity, IAmbiguity } from '@tide/types';
export interface INaturalLanguageProcessor {
     ...
     * @performance <300ms
     */
    processMessage(message: string, context: IConversationContext): Promise<Result<IUnderstanding>>;
    /**
     ...
     * @performance <100ms
     */
    extractEntities(message: string, context: IConversationContext): Promise<Result<IEntity[]>>;
    /**
     ...
     * @performance <100ms
     */
    detectAmbiguities(message: string, understanding: IUnderstanding): Promise<Result<IAmbiguity[]>>;
    /**
     ...
     */
    resolveReferences(text: string, context: IConversationContext): Promise<Result<Record<string, unknown>>>;
}
//# sourceMappingURL=INaturalLanguageProcessor.d.ts.map