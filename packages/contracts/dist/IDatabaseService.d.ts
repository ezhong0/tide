...
export interface IDatabaseService {
     ...
     * @performance <100ms
     */
    find<T>(table: string, where?: WhereCondition, options?: QueryOptions): Promise<Result<T[]>>;
    /**
     * Find single record
     * @param table Table name
     * @param where Where conditions
     ...
     * @performance <50ms
     */
    findOne<T>(table: string, where: WhereCondition): Promise<Result<T | null>>;
    /**
     * Find by ID
     * @param table Table name
     * @param id Record ID
     ...
     */
    withTransaction<T>(callback: (tx: Transaction) => Promise<T>): Promise<Result<T>>;
    /**
     ...
     * @performance <100ms
     */
    upsert<T>(table: string, data: Partial<T>, conflictColumns: string[]): Promise<Result<T>>;
    /**
     * Bulk upsert
     * @param table Table name
     * @param data Array of records
     ...
     */
    bulkUpsert<T>(table: string, data: Partial<T>[], conflictColumns: string[]): Promise<Result<T[]>>;
    /**
     * Query JSONB field
     * @param table Table name
     ...
     */
    queryJsonb<T>(table: string, column: string, path: string, value: unknown): Promise<Result<T[]>>;
    /**
     * Update JSONB field
     * @param table Table name
     * @param id Record ID
     ...
     * @performance <50ms
     */
    updateJsonb(table: string, id: UUID, column: string, path: string, value: unknown): Promise<Result<void>>;
    /**
     * Full text search
     * @param table Table name
     ...
     */
    search<T>(table: string, columns: string[], query: string, options?: SearchOptions): Promise<Result<SearchResult<T>[]>>;
    /**
     ...
     */
    refreshMaterializedView(viewName: string, concurrently?: boolean): Promise<Result<void>>;
    /**
     ...
     * @performance Async operation
     */
    createIndex(table: string, columns: string[], options?: IndexOptions): Promise<Result<void>>;
    /**
