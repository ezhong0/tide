...
import { SendEmailParams, DraftEmailParams, DraftContext, EmailAction, EmailSyncStatus, EmailDomain, EmailQuery, EmailResponse, EmailTemplate, EmailAnalytics, DraftSuggestion } from '@tide/types';
