...
import { EmailDomain, EmailQuery, SendEmailParams, DraftEmailParams, DraftContext, DraftSuggestion, EmailResponse, EmailAction, EmailTemplate, EmailAnalytics, EmailSyncStatus } from '@tide/types';
