 ...
 * - Undo action: <500ms
 */
import { Result, IAction, IActionPreview, IActionResult, UserId } from '@tide/types';
export interface IActionPreviewService {
     ...
     * @performance <500ms
     */
    generatePreview(action: IAction, userId: UserId): Promise<Result<IActionPreview>>;
    /**
     ...
     * @performance <1000ms
     */
    executeAction(action: IAction, userId: UserId, modifications?: Record<string, unknown>): Promise<Result<IActionResult>>;
    /**
     ...
     * @performance <100ms
     */
    validateAction(action: IAction): Promise<Result<{
        valid: boolean;
        errors?: string[];
    }>>;
}
//# sourceMappingURL=IActionPreviewService.d.ts.map