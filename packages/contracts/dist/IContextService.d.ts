...
import { UserContext, UserProfile, Relationship, Contact, ContextPreferences, WorkContext, BehaviorProfile, LearningProfile, Project, Team, Goal, Priority, LearnedPreference, ImprovementArea } from '@tide/types';
export interface IContextService {
     ...
     * @performance <100ms
     */
    updateUserContext(userId: UserId, updates: Partial<UserContext>): Promise<Result<UserContext>>;
    /**
     * Get user profile
     * @param userId User identifier
     ...
     * @performance <100ms
     */
    updateUserProfile(userId: UserId, updates: Partial<UserProfile>): Promise<Result<UserProfile>>;
    /**
     ...
     * @performance <100ms
     */
    upsertRelationship(userId: UserId, relationship: Omit<Relationship, 'relationshipId'>): Promise<Result<UUID>>;
    /**
     ...
     * @performance <50ms
     */
    recordInteraction(userId: UserId, contactEmail: Email, interactionType: InteractionType): Promise<Result<Relationship>>;
    /**
     ...
     * @performance <100ms
     */
    updatePreferences(userId: UserId, preferences: Partial<ContextPreferences>): Promise<Result<void>>;
    /**
     ...
     * @performance <100ms
     */
    addProject(userId: UserId, project: Omit<Project, 'projectId'>): Promise<Result<UUID>>;
    /**
     ...
     * @performance <100ms
     */
    updateProject(projectId: UUID, updates: Partial<Project>): Promise<Result<Project>>;
    /**
     ...
     * @performance <100ms
     */
    upsertTeam(userId: UserId, team: Omit<Team, 'teamId'>): Promise<Result<UUID>>;
    /**
     ...
     * @performance <100ms
     */
    upsertGoal(userId: UserId, goal: Omit<Goal, 'goalId'>): Promise<Result<UUID>>;
    /**
     ...
     * @performance <100ms
     */
    upsertPriority(userId: UserId, priority: Omit<Priority, 'priorityId'>): Promise<Result<UUID>>;
    /**
     ...
     * @performance <200ms
     */
    learnBehavior(userId: UserId, observation: BehaviorObservation): Promise<Result<LearningResult>>;
    /**
     ...
     * @performance <100ms
     */
    recordLearnedPreference(userId: UserId, preference: Omit<LearnedPreference, 'preferenceId'>): Promise<Result<void>>;
    /**
     ...
     * @performance <300ms
     */
    getRelationshipRecommendations(userId: UserId): Promise<Result<RelationshipRecommendation[]>>;
    /**
...
//# sourceMappingURL=IContextService.d.ts.map