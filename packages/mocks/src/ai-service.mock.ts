import { AIIntent, AIResponse, SuggestedAction, Email, Intent } from '@tide/contracts';
...
export class MockAIService {
  ...
  async triageEmail(email: Email): Promise<{ priority: string; category: string; summary: string }> {
    await this.delay();
