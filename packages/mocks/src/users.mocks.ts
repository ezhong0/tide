...
export const mockEncryptedCredentials: EncryptedCredentials = {
...
export const mockFollowUpDefaults: FollowUpDefaults = {
...
export const mockUser1: UserRow = {
...
export const mockUser2: UserRow = {
...
export const mockUserPreferences1: UserPreferencesRow = {
  id: createUserId('660e8400-e29b-41d4-a716-446655440001') as any,
  userId: mockUser1.id,
...
export const mockUserPreferences2: UserPreferencesRow = {
  id: createUserId('660e8400-e29b-41d4-a716-446655440002') as any,
  userId: mockUser2.id,
