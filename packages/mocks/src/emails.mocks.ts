...
import type { EmailRow, Attachment } from '@tide/shared-types';
...
export const mockEmail1: EmailRow = {
...
export const mockEmail2: EmailRow = {
...
export const mockEmail3: EmailRow = {
